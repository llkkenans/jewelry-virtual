...
export default function SilkShader({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const gl = (canvas.getContext("webgl", { antialias: false, premultipliedAlpha: false }) ||
      canvas.getContext("experimental-webgl", { antialias: false, premultipliedAlpha: false })) as WebGLRenderingContext | null
    if (!gl) {
    ...
    const draw = (seconds: number) => {
      gl.uniform4f(uScene, width, height, seconds * 0.86, 4.0)
